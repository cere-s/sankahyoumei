...
export const demoEntries: ParticipationEntry[] = [
  ...
  entry({ id: 'demo-en-1', eventId: 'demo-ev-1', displayName: 'レムコス花子', xId: 'demo_user', userId: DEMO_USER_ID, xUsernameSnapshot: 'demo_user', participationType: 'cosplay', participationDate: '2026-07-04', comment: 'はじめまして！1日目参加します。お気軽に声かけてください。', cosplayInfo: C('原神', 'フリーナ', 'greeting_welcome'), cosplayPlans: [{ workTitle: '原神', characterName: 'フリーナ', timeSlot: '昼〜夕方', costumeLabel: '通常衣装' }, { workTitle: 'NEEDY GIRL OVERDOSE', characterName: '超てんちゃん', timeSlot: '夜', costumeLabel: '通常' }], imageUrl: 'https://picsum.photos/seed/cos1/1200/675', imageAlt: 'レムコス花子 の参加表明画像', imageWidth: 1200, imageHeight: 675, createdAt: '2026-06-20T10:00:00Z' }),
  ...
  entry({ id: 'demo-en-3', eventId: 'demo-ev-1', displayName: 'ごじょー', xId: 'cos_satoru', participationType: 'cosplay', participationDate: '2026-07-04', comment: '相互の方ぜひ！', cosplayInfo: C('呪術廻戦', '五条悟', 'mutual_ok'), imageUrl: 'https://picsum.photos/seed/cos3/1200/675', imageAlt: 'ごじょー の参加表明画像', imageWidth: 1200, imageHeight: 675, createdAt: '2026-06-22T12:00:00Z' }),
  ...
  entry({ id: 'demo-en-8', eventId: 'demo-ev-7', displayName: 'レムコス花子', xId: 'demo_user', userId: DEMO_USER_ID, xUsernameSnapshot: 'demo_user', participationType: 'cosplay', participationDate: '2026-08-01', comment: '夏コスします！', cosplayInfo: C('ホロライブ', '兎田ぺこら', 'greeting_welcome'), imageUrl: 'https://picsum.photos/seed/cos8/1200/675', imageAlt: 'レムコス花子 の参加表明画像', imageWidth: 1200, imageHeight: 675, createdAt: '2026-06-24T09:00:00Z' }),

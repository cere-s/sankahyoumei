...
export const demoEntries: ParticipationEntry[] = [
  ...
  entry({ id: 'demo-en-1', eventId: 'demo-ev-1', displayName: 'レムコス花子', xId: 'demo_user', userId: DEMO_USER_ID, xUsernameSnapshot: 'demo_user', participationType: 'cosplay', participationDate: '2026-07-04', comment: 'はじめまして！1日目参加します。お気軽に声かけてください。', cosplayInfo: C('Re:ゼロから始める異世界生活', 'レム', 'greeting_welcome'), imageUrl: 'https://picsum.photos/seed/cos1/1200/675', imageAlt: 'レムコス花子 の参加表明画像', imageWidth: 1200, imageHeight: 675, createdAt: '2026-06-20T10:00:00Z' }),
